...
func TestDecode(t *testing.T) {
	...
	result, remainder = Decode([]byte(pkcs8KeyWithPassword))
	if result == nil {
		t.Fatal("#6 block is nil")
	}
	if len(remainder) > 0 {
		t.Fatal("#6 got some extra bytes")
	}
	if !reflect.DeepEqual(result, pkcs8KeyWithPasswordPEMBlock) {
		t.Fatalf("#6 got:%#v want:%#v", result, pkcs8KeyWithPasswordPEMBlock)
	}
}

var pkcs8KeyWithPasswordPEMBlock = &Block{
	Type: "ENCRYPTED PRIVATE KEY",
	Headers: map[string]string{
		"DEK-Info": "AES-128-CBC,5155ff4124c211b1a67612918898d369",
		"Key-Info": "PBKDF2,2048,912446a766ad8e47",
	},
	Bytes: []uint8{,
	},
}
